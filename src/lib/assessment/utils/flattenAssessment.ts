...
export function flattenAssessment(assessment: AssessmentWithRelations | null): AssessmentResponse | null {
    ...
    return {
        ...
        mobilityFactorMulti: (assessment.acceptanceFactors as any)?.mobilityFactorMulti ?? null,
        perceptionAwareness: (assessment.acceptanceFactors as any)?.perceptionAwareness ?? null,
        evacuationPlanClear: (assessment.acceptanceFactors as any)?.evacuationPlanClear ?? null,
        noPanicRisk: (assessment.acceptanceFactors as any)?.noPanicRisk ?? null,
