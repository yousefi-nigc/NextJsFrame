...
export function flattenAssessment(assessment: AssessmentWithRelations | null): AssessmentResponse | null {
    ...
    return {
        ...
        mainActivityKey: assessment.acceptanceFactors?.mainActivityKey ?? null,
        ...
        heatTransferTypeKey: assessment.acceptanceFactors?.heatTransferTypeKey ?? null,
        generatorLocation: assessment.acceptanceFactors?.generatorLocation ?? null,
        generatorLocationKey: assessment.acceptanceFactors?.generatorLocationKey ?? null,
        ...
        combustibleDustKey: assessment.acceptanceFactors?.combustibleDustKey ?? null,
        weldingOperations: assessment.acceptanceFactors?.weldingOperations ?? null,
        additionalCarpentryPlastic: assessment.acceptanceFactors?.additionalCarpentryPlastic ?? null,
        specialRisk: assessment.acceptanceFactors?.specialRisk ?? null,
        ...
        exitUnitsX: assessment.acceptanceFactors?.exitUnitsX ?? null,
        separatePathsK: assessment.acceptanceFactors?.separatePathsK ?? null,
        ...
        requiredWaterCapacity: assessment.protectionFactors?.requiredWaterCapacity ?? null,
        w2Penalty: assessment.protectionFactors?.w2Penalty ?? null,
        distributionNetwork: assessment.protectionFactors?.distributionNetwork ?? null,
        pipeDiameter: assessment.protectionFactors?.pipeDiameter ?? null,
        isRingNetwork: assessment.protectionFactors?.isRingNetwork ?? null,
        waterFlowCapacity: assessment.protectionFactors?.waterFlowCapacity ?? null,
        distributionNetworkAdequacy: assessment.protectionFactors?.distributionNetworkAdequacy ?? null,
        ...
        equivalentHydrant25: assessment.protectionFactors?.equivalentHydrant25 ?? null,
        averageHydrantDistance: assessment.protectionFactors?.averageHydrantDistance ?? null,
        w4Score: assessment.protectionFactors?.w4Score ?? null,
        staticPressureRequired: assessment.protectionFactors?.staticPressureRequired ?? null,
        staticPressureAvailable: assessment.protectionFactors?.staticPressureAvailable ?? null,
        w5Score: assessment.protectionFactors?.w5Score ?? null,
        detectionType: assessment.protectionFactors?.detectionType ?? null,
        s1ElectronicSystem: assessment.protectionFactors?.s1ElectronicSystem ?? null,
        s1ZoneIdentification: assessment.protectionFactors?.s1ZoneIdentification ?? null,
        ...
        industrialBrigadeLabel: (assessment.protectionFactors as any)?.industrialBrigadeLabel ?? null,
        s6OtherSuppression: assessment.protectionFactors?.s6OtherSuppression ?? null,
        s7UnlimitedWater: assessment.protectionFactors?.s7UnlimitedWater ?? null,
        s8DedicatedWater: assessment.protectionFactors?.s8DedicatedWater ?? null,
        s9WaterControl: assessment.protectionFactors?.s9WaterControl ?? null,
        ...
        n1ContinuousPresence: assessment.protectionFactors?.n1ContinuousPresence ?? null,
        n1ManualWarning: assessment.protectionFactors?.n1ManualWarning ?? null,
        n1FireDeptNotification: assessment.protectionFactors?.n1FireDeptNotification ?? null,
        n1ResidentAlarm: assessment.protectionFactors?.n1ResidentAlarm ?? null,
        ...
        stairwaysIndex: (assessment.protectionFactors as any)?.stairwaysIndex ?? null,
        horizontalExit: assessment.protectionFactors?.horizontalExit ?? null,
        sprinklers: assessment.protectionFactors?.sprinklers ?? null,
        u1PartialDetection: assessment.protectionFactors?.u1PartialDetection ?? null,
        u2Max300Occupants: assessment.protectionFactors?.u2Max300Occupants ?? null,
        u3VoiceEvacuation: assessment.protectionFactors?.u3VoiceEvacuation ?? null,
        u4MarkedExits: assessment.protectionFactors?.u4MarkedExits ?? null,
        u5SmokeEvacuation: assessment.protectionFactors?.u5SmokeEvacuation ?? null,
        ...
        immediateActivityTransfer: (assessment.protectionFactors as any)?.immediateActivityTransfer ?? null,
