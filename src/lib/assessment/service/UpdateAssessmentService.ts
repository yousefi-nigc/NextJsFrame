...
export async function updateAssessmentService({
    ...
    try {
        ...
        const currentInputs = {
            ...
            occupantFactorKey: existing.occupantFactorKey ?? undefined,
            exitWidths: existing.exitWidths ?? undefined,
            exitWidthTotal: existing.exitWidthTotal ?? undefined,
            mobilityFactor: existing.mobilityFactor ?? undefined,
            exitCountToOpenSpace: existing.exitCountToOpenSpace ?? undefined,
