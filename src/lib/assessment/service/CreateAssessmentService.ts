        ...
        const assessment = await db.$transaction(async (tx) => {
            ...
            await tx.assessmentAcceptanceFactors.create({
                data: {
                    ...
                    mainActivityKey: inputs.mainActivityKey ?? null,
                    secondaryActivity: inputs.secondaryActivity,
                    heatTransferType: inputs.heatTransferType,
                    heatTransferTypeKey: inputs.heatTransferTypeKey ?? null,
                    generatorLocation: inputs.generatorLocation,
                    generatorLocationKey: inputs.generatorLocationKey ?? null,
                    ...
                    combustibleDustKey: inputs.combustibleDustKey ?? null,
                    weldingOperations: inputs.weldingOperations,
                    additionalCarpentryPlastic: inputs.additionalCarpentryPlastic,
                    specialRisk: inputs.specialRisk,
                    ...
                    exitUnitsX: inputs.exitUnitsX,
                    separatePathsK: inputs.separatePathsK,
