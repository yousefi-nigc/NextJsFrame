...
CREATE TABLE "assessment_acceptance_factors" (
    ...
    "exitUnitsX" DOUBLE PRECISION,
    "separatePathsK" DOUBLE PRECISION,
...
CREATE TABLE "assessment_protection_factors" (
    ...
    "requiredWaterCapacity" DOUBLE PRECISION,
    "w2Penalty" DOUBLE PRECISION,
    "distributionNetwork" TEXT,
    "pipeDiameter" TEXT,
    "isRingNetwork" BOOLEAN,
    "waterFlowCapacity" DOUBLE PRECISION,
    "distributionNetworkAdequacy" TEXT,
    "hydrantCount25" INTEGER,
    "hydrantCount3" INTEGER,
    "hydrantCount4" INTEGER,
    "equivalentHydrant25" DOUBLE PRECISION,
    "averageHydrantDistance" DOUBLE PRECISION,
    "w4Score" DOUBLE PRECISION,
    "staticPressureRequired" DOUBLE PRECISION,
    "staticPressureAvailable" DOUBLE PRECISION,
    "w5Score" DOUBLE PRECISION,
    ...
    "industrialBrigadeLabel" TEXT,
    "s6OtherSuppression" DOUBLE PRECISION,
