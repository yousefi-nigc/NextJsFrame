...
export async function GET(
    ...
    try {
        return await getProjectController(request, params.id);
    } catch (error: any) {
...
export async function PUT(
    ...
    try {
        return await updateProjectController(request, params.id);
    } catch (error: any) {
        return NextResponse.json(
            { error: error.message || "Internal server error" },
            { status: 500 }
...
export async function DELETE(
    ...
    try {
        return await deleteProjectController(request, params.id);
    } catch (error: any) {
        return NextResponse.json(
            { error: error.message || "Internal server error" },
            { status: 500 }
